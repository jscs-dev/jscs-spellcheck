...
Thanks for wanting to contribute! This document describes some points about the contribution process for the JSCS Spellcheck ackage.
...
please report it using [GitHub Issues](https://github.com/jscs-dev/jscs-spellcheck/issues). Try searching
...
1. Fork the jscs-spellcheck repository
...
1. Consider setting up the appropriate [JSCS editor package](https://github.com/jscs-dev/node-jscs#friendly-packages)
 - We use JSCS to check this codebase
...
You can find other examples of this format by [viewing recent commits](https://github.com/jscs-dev/jscs-spellcheck/commits/master) made to master.
